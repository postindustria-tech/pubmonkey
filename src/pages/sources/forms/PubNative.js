...
let defaultAdvertiser = "pubnative";
...
class PubNativeCreateOrder extends CreateOrderForm {
                ...
                <Row className={"main-form"}>
                    ...
                    <Col className={"col-sm-4"}>
                        <Row className={"mb-0"}>
                            ...
                            <Col className={"col-sm-8 mb-0"}>
                                <Label className={"mp-label"}>
                                    Keyword Step:{" "}
                                </Label>
                                <InputNumber
                                    invalid={!isEmpty(this.props.formErrors.keywordStep)}
                                    min={0.01}
                                    max={1000}
                                    step={0.01}
                                    value={this.props.attributes.keywordStep}
                    ...
                    <Col className={"col-sm-4"}>
                        <Label className={"mp-label"}>Ad_ZONE_ID: </Label>
                        <CustomInput
                            invalid={!isEmpty(this.props.formErrors.Ad_ZONE_ID)}
                            type="text"
                            id={"Ad_ZONE_ID"}
                            name={"Ad_ZONE_ID"}
                            value={this.props.attributes.Ad_ZONE_ID}
                            onChange={this.handleInputChange}
                            className={"mp-form-control"}
                        />
                    </Col>
...
export default connect(mapStateToProps, null)(PubNativeCreateOrder)